<?php
  ...
  if(!isset($_GET['id'])){
      ...
      if($sq=mysql_fetch_array($sql)){
          $v_code=$sq['code'];
          mysql_query("insert into visit values('$id','$v_code')");
      }
      mysql_query("insert into profile values('$id')");
      
      $rs=mysql_query("select * from matri where code='$id'");
            ...
            <table class="table_working_hours">
                <tbody>
                    <tr class="opened_1">
                        ...
                        <td class="day_value"><?php echo $r['name']; ?></td>
                    </tr>
                    <tr class="opened">
